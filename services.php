		...
		<div class="content">
			...
			<div class="shooting aeropanoramabg">	
					...
					<div class="shooting_block">				
						<div class="shooting__leftbox">
							...
							<div class="shooting__txtbox">
								...
								<p>Небольшие квадрокоптеры для съемок малобюджетных роликов, тяжелый гексакоптер с профессиональными камерами и каосильный коптер с подвесом на камеры линейки RED, который принимает участие
									в съемках большого кино.</p>
								</div>
								<div class="shooting__button">
									<a class="button button_1" href="#">Арендовать квадрокоптер</a>
								</div>
							</div>
				...
				<div class="shooting">	
					<div class="container">
						<div class="col-md-12">
							<h1 class="services-h1">Мастер-класс по аэросъемки</h1>
						</div>
						<div class="clearfix"></div>
						<div class="col-md-6">
